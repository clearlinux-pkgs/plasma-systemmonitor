...
Version  : 5.25.1
Release  : 18
URL      : https://download.kde.org/stable/plasma/5.25.1/plasma-systemmonitor-5.25.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.25.1/plasma-systemmonitor-5.25.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.25.1/plasma-systemmonitor-5.25.1.tar.xz.sig
...
%prep
%setup -q -n plasma-systemmonitor-5.25.1
cd %{_builddir}/plasma-systemmonitor-5.25.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655835295
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/plasma-systemmonitor-5.25.1/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/plasma-systemmonitor/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/plasma-systemmonitor-5.25.1/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/plasma-systemmonitor/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/plasma-systemmonitor-5.25.1/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/plasma-systemmonitor/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/plasma-systemmonitor-5.25.1/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/plasma-systemmonitor/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/plasma-systemmonitor-5.25.1/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/plasma-systemmonitor/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/plasma-systemmonitor-5.25.1/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/plasma-systemmonitor/3c3d7573e137d48253731c975ecf90d74cfa9efe
cp %{_builddir}/plasma-systemmonitor-5.25.1/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/plasma-systemmonitor/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/plasma-systemmonitor-5.25.1/LICENSES/LGPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/plasma-systemmonitor/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/plasma-systemmonitor-5.25.1/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/plasma-systemmonitor/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/plasma-systemmonitor-5.25.1/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/plasma-systemmonitor/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/plasma-systemmonitor-5.25.1/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/plasma-systemmonitor/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/plasma-systemmonitor-5.25.1/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/plasma-systemmonitor/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/plasma-systemmonitor-5.25.1/logo.png.license %{buildroot}/usr/share/package-licenses/plasma-systemmonitor/ce37caa1aac2e9037a7c5648a7519d5bb0970ed3
pushd clr-build
%make_install
popd
