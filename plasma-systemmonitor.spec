...
Version  : 5.25.4
Release  : 21
URL      : https://download.kde.org/stable/plasma/5.25.4/plasma-systemmonitor-5.25.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.25.4/plasma-systemmonitor-5.25.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.25.4/plasma-systemmonitor-5.25.4.tar.xz.sig
...
%prep
%setup -q -n plasma-systemmonitor-5.25.4
cd %{_builddir}/plasma-systemmonitor-5.25.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659719322
mkdir -p clr-build
pushd clr-build
