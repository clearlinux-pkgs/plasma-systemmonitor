...
Version  : 5.27.7
Release  : 38
URL      : https://download.kde.org/stable/plasma/5.27.7/plasma-systemmonitor-5.27.7.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.7/plasma-systemmonitor-5.27.7.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.7/plasma-systemmonitor-5.27.7.tar.xz.sig
...
%prep
%setup -q -n plasma-systemmonitor-5.27.7
cd %{_builddir}/plasma-systemmonitor-5.27.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1690903556
mkdir -p clr-build
pushd clr-build
