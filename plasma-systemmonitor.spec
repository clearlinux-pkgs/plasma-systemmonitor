...
Version  : 6.2.5
Release  : 60
URL      : https://download.kde.org/stable/plasma/6.2.5/plasma-systemmonitor-6.2.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.2.5/plasma-systemmonitor-6.2.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.5/plasma-systemmonitor-6.2.5.tar.xz.sig
...
%setup -q -n plasma-systemmonitor-6.2.5
cd %{_builddir}/plasma-systemmonitor-6.2.5
pushd ..
cp -a plasma-systemmonitor-6.2.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736201991
mkdir -p clr-build
pushd clr-build
