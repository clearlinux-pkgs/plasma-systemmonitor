...
Version  : 5.27.10
Release  : 41
URL      : https://download.kde.org/stable/plasma/5.27.10/plasma-systemmonitor-5.27.10.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.10/plasma-systemmonitor-5.27.10.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.10/plasma-systemmonitor-5.27.10.tar.xz.sig
...
%prep
%setup -q -n plasma-systemmonitor-5.27.10
cd %{_builddir}/plasma-systemmonitor-5.27.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703027603
mkdir -p clr-build
pushd clr-build
