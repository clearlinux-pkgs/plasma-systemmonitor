...
Version  : 5.26.4
Release  : 27
URL      : https://download.kde.org/stable/plasma/5.26.4/plasma-systemmonitor-5.26.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.26.4/plasma-systemmonitor-5.26.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.4/plasma-systemmonitor-5.26.4.tar.xz.sig
...
%prep
%setup -q -n plasma-systemmonitor-5.26.4
cd %{_builddir}/plasma-systemmonitor-5.26.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669828443
mkdir -p clr-build
pushd clr-build
