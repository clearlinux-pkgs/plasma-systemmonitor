...
Source0  : https://download.kde.org/stable/plasma/6.3.0/plasma-systemmonitor-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.0/plasma-systemmonitor-6.3.0.tar.xz.sig
...
%setup -q -n plasma-systemmonitor-6.3.0
cd %{_builddir}/plasma-systemmonitor-6.3.0
pushd ..
cp -a plasma-systemmonitor-6.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739305199
mkdir -p clr-build
pushd clr-build
