...
Version  : 5.27.3
Release  : 33
URL      : https://download.kde.org/stable/plasma/5.27.3/plasma-systemmonitor-5.27.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.3/plasma-systemmonitor-5.27.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.3/plasma-systemmonitor-5.27.3.tar.xz.sig
...
%prep
%setup -q -n plasma-systemmonitor-5.27.3
cd %{_builddir}/plasma-systemmonitor-5.27.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679532232
mkdir -p clr-build
pushd clr-build
