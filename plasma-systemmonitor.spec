...
Version  : 6.2.4
Release  : 59
URL      : https://download.kde.org/stable/plasma/6.2.4/plasma-systemmonitor-6.2.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.2.4/plasma-systemmonitor-6.2.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.4/plasma-systemmonitor-6.2.4.tar.xz.sig
...
%setup -q -n plasma-systemmonitor-6.2.4
cd %{_builddir}/plasma-systemmonitor-6.2.4
pushd ..
cp -a plasma-systemmonitor-6.2.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735336553
mkdir -p clr-build
pushd clr-build
