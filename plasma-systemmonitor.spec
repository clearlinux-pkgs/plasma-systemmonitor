...
Version  : 6.3.1
Release  : 63
URL      : https://download.kde.org/stable/plasma/6.3.1/plasma-systemmonitor-6.3.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.1/plasma-systemmonitor-6.3.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.1/plasma-systemmonitor-6.3.1.tar.xz.sig
...
%setup -q -n plasma-systemmonitor-6.3.1
cd %{_builddir}/plasma-systemmonitor-6.3.1
pushd ..
cp -a plasma-systemmonitor-6.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739915283
mkdir -p clr-build
pushd clr-build
