...
%setup -q -n plasma-systemmonitor-6.1.5
cd %{_builddir}/plasma-systemmonitor-6.1.5
pushd ..
cp -a plasma-systemmonitor-6.1.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726013706
mkdir -p clr-build
pushd clr-build
