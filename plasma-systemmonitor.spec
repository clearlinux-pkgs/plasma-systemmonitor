...
Source0  : https://download.kde.org/stable/plasma/5.27.9/plasma-systemmonitor-5.27.9.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.9/plasma-systemmonitor-5.27.9.tar.xz.sig
...
%prep
%setup -q -n plasma-systemmonitor-5.27.9
cd %{_builddir}/plasma-systemmonitor-5.27.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698291083
mkdir -p clr-build
pushd clr-build
